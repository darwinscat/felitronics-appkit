...
//==============================================================================
// felitronics::appkit::IconButton — font-independent VECTOR toolbar icons, moved verbatim from
// OrbitCab's ui/IconButton.h. No font glyphs — they don't render in the plugin font — so every
// mark is a stroked/filled path scaled from a 24×24 design box, with a hover wash:
//   • save / saveAs — floppy disk (label panel; saveAs swaps it for a "+" = save a new copy)
...
//   • trash         — lid + handle, tapered open-top bin, three ribs
// The hardened sibling of brand::GearButton (a text-glyph ⚙, still available): supersedes it
// wherever font-independence matters. Colours are public members whose defaults reproduce
// OrbitCab's neutral/panel look 1:1. Header-only; the consumer supplies JUCE (juce_gui_basics).
//==============================================================================
...
public:
    ...
    juce::Colour colour      { 0xffc0c0c8 };    // mark + frame border (OrbitCab's neutral)
    juce::Colour panelColour { 0xff1b1b1f };    // framed panel fill (OrbitCab's panel)
